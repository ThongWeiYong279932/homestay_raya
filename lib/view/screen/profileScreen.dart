...
class _ProfileScreenState extends State<ProfileScreen> {
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      "${ServerConfig.Server}/Homestay_Raya/assets/images/profile/${widget.user.id}.png?v=$val",
  ...
  void _updateProfileImage(File? image) {
    ...
    http.post(Uri.parse("${ServerConfig.Server}/Homestay_Raya/php/update_profile.php"),
        body: {
