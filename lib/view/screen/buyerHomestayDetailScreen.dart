...
class buyerHomestayDetailScreen extends StatefulWidget {
  final Homestays homestay;
  final User user;
  final User seller;
  const buyerHomestayDetailScreen(
      {super.key,
  ...
  @override
  State<buyerHomestayDetailScreen> createState() => _buyerHomestayDetailScreenState();
}

class _buyerHomestayDetailScreenState extends State<buyerHomestayDetailScreen> {
              ...
              children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Room No:', style: TextStyle(fontSize: 20.0))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.homestay.homestayRoomno}",
                            style: const TextStyle(fontSize: 20.0))
                      ]),
                ]),
                TableRow(children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Contact No:', style: TextStyle(fontSize: 20.0))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
  ...
  Future<void> _onRoute() async {
    final Uri launchUri = Uri(
        ...
        path: "www.google.com/maps/@" +
            ...
            "," +
            widget.homestay.homestayLong.toString() +
            "20z");
    await launchUrl(launchUri);
  }
  ...
  void _onShowMap() {
    ...
    double lng = double.parse(widget.homestay.homestayLong.toString());
